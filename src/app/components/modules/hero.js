...
export default function Hero() {
  return (
    <section id='introductie' className="container relative w-full grid grid-cols-12 gap-6 mt-[90px] md:mt-[100px] lg:mt-[196px] z-30 min-h-[80vh]">
      ...
      <div className="flex flex-col h-full col-span-12 md:col-span-6">
        <h1 className="mb-8 text-h1-sm md:text-h1-md lg:text-h1 reveal-on-scroll">Er word nog aan deze website gebouwd!</h1>
        ...
        <div className="flex justify-start items-center w-fit mt-10 md:mt-[52px] group reveal-on-scroll">
          {/* <a href="#interviews" className="text-xs btn-fill btn-white group-hover:bg-black group-hover:text-white">Bekijk de interviews</a>
